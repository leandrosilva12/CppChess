...
Bitboard is_check(int color, int square, Bitboard pieces[]) {
   ...
   return (pawn_attacks_table[color][square] & opPawns)
        | (knight_attacks_table[square] & opKnights)
        | (bishop_attacks (square, pieces[white] | pieces[black]  & opBQ))
        | (rook_attacks   (square, pieces[white] | pieces[black]  & opRQ))
        ;
}
